---
type: Reference
title: language-tutor project overview
description: What the language-tutor project is, its core value, requirements, scope boundaries, constraints, and key decisions.
