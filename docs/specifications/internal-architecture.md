---
type: Specification
title: Internal architecture research
description: Maintainer-facing architecture research — boundaries, schemas, lifecycle state machine, data flow, build order, anti-patterns, and host-adapter setup.
...
**Why wrong:** Out of scope per the project overview ("LLM generates exercises on-demand"). Defeats "any L2" wedge.
...
| (None other) | — | Per the project overview: no paid APIs, no telemetry, no cloud. |
