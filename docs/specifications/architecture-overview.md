...
description: Module-level expansion of the high-level architecture — layers, boot sequence, data shapes, and what is deliberately excluded.
timestamp: 2026-06-22
---

# Architecture

This is the module-level expansion of the high-level diagram in the README. For maintainer-facing internals see [/specifications/internal-architecture.md](/specifications/internal-architecture.md).
