...
type: Specification
title: Requirements
description: v1, v2, and out-of-scope requirements for language-tutor with phase traceability.
...
Which phases cover which requirements. (Phase detail formerly tracked in the
roadmap, which has been retired.)
