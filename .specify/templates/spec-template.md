...
<!--
  ACTION REQUIRED: Capture constraints from .specify/memory/constitution.md.
  Keep this technology-aware only where the constitution already mandates it.
-->

- **Affected Layers**: [Host adapter/core/DAL/renderer/skills/hooks/packaging]
